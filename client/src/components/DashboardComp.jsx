...
<div className="flex flex-wrap gap-4 py-6 mx-auto justify-center ">
  ...
  <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800 overflow-x-auto scrollbar-colored">
  ...
  <div className="flex flex-col w-full md:w-auto shadow-md px-6 py-2 rounded-md dark:bg-gray-800 overflow-x-auto scrollbar-colored">
    <div className="flex justify-between p-3 text-sm font-semibold">
    ...
    <Table hoverable className="w-full">
      ...
      {posts && posts.map((post)=>(
        ...
        <Table.Body key={post._id} className="divide-y">
            ...
            <Table.Cell className="w-full">{post.title}</Table.Cell>
